...
public class IdentityUserService {
	...
	public IdentityUserService(UserRepository users, UserProfileRepository profiles, PasswordEncoder encoder) {
		this.users = users;
	...
	public void updateProfile(String username, String displayName) {
		...
		var profile = profiles.findById(user.getId())
				.orElseGet(() -> new com.discover.app.identity.domain.UserProfile(user, displayName));
