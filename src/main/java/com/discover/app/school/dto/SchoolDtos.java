...
public final class SchoolDtos {
	...
	public record GradeRequest(@NotBlank @Size(max = 100) String name, @NotBlank @Size(max = 100) String section,@NotBlank @Size(max = 100) String description, @NotNull @Min(1) Integer displayOrder) {
	}
