...
public class StudentEnrollment {
	...
	public StudentEnrollment(Student student, AcademicYear academicYear, Grade grade, User requestedBy,
	...
	public void approve(User admin, LocalDateTime when) {
		if (status != EnrollmentStatus.REQUESTED)
			throw new IllegalStateException("Only requested enrollments can be approved");
	...
	public void cancel() {
		if (status != EnrollmentStatus.REQUESTED)
			throw new IllegalStateException("Only requested enrollments can be cancelled");
