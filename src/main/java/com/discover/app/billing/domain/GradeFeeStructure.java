...
@Table(name = "grade_fee_structures", indexes = {
		@Index(name = "idx_gfs_grade_dates", columnList = "grade_id,effective_from,effective_to"),
...
public class GradeFeeStructure {
	...
	public GradeFeeStructure(Grade grade, FeeStructure feeStructure, LocalDate effectiveFrom) {
		this.grade = grade;
